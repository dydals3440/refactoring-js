...
class Organization {
  ...
  get rawData() {
    // 위에다 this.#name, this.#country이렇게해서 각각리턴해줘도되지만, 그냥 this.#data로 정의하고 ... 스프레드 연산자를 통해, 새로운 객체로 만들어서, 외부에서 수정해도, 내가 갖고있는 데이터에는 영향이 없게 불변성을 유지해야함!
    return { ...this.#data }; // 얕은복사
  }
}
